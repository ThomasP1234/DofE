...
class Animation():
    def main(self):
        ...
        self.root = Tk()
        self.root.geometry("{0}x{1}+280+200".format(self.root_width, self.root_height2))
